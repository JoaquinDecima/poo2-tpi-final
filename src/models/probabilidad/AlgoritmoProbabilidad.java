...
public interface AlgoritmoProbabilidad {
	...
	public double getPosibilidadDeVictoriaLocal(Partido pPartido, Proveedor proveedor);
	...
	public double getPosibilidadDeEmpate(Partido pPartido, Proveedor proveedorDataPartidos);
}
